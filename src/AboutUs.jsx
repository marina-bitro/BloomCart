...
const AboutUs = forwardRef((props, ref) => {
  return (
    <div className="about-us-container" ref={ref} id="about-us">
      {/* <h1 className="about-us-heading">About Us</h1> */}
      <p className="about-us-description">Welcome to Paradise Bloom Nursery, where green meets serenity!</p>
      <p className="about-us-content">
        At Paradise Bloom Nursery, we are passionate about bringing nature closer to you. Our mission is to provide a wide range of 
